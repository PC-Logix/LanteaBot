...
public class DrinkPotion extends AbstractListener {
	...
	private void initCommands() {
		...
		local_command.setHelpText("Drink a potion with a certain consistency and appearance and something might happen. Syntax: " + Config.commandprefix + local_command.getCommand() + " [potion] Potion needs to contain a valid consistency, appearance and the word 'potion', See the " + potion_stats.getCommand() + " command for a list.");
